...
export async function GET() {
    ...
    try {
        ...
        return NextResponse.json({ success: false, message: 'Error al cargar historial.' }, { status: 500 });
    }
}
...
export async function DELETE(req: NextRequest) {
    ...
    try {
        ...
        if (all === 'true') {
            ...
            return NextResponse.json({ success: false, message: 'ID o parámetro "all" requerido.' }, { status: 400 });
        }
