        ...
        <div className={styles.container}>
            <div className={styles.card}>
                ...
                <section id="aviso-legal" className={styles.section}>
                    ...
                    <h3 className={styles.subTitle}>1. Datos de identificación</h3>
                ...
                <section id="condiciones-contratacion" className={styles.section}>
                    <h2 className={styles.sectionTitle}>Condiciones de Contratación</h2>
                    <h3 className={styles.subTitle}>Contratación de Servicios</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Proceso de Contratación</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Cancelación del Servicio</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Modificación de Condiciones</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Disponibilidad del Servicio</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Limitación de Responsabilidad</h3>
                    <p className={styles.text}>
                ...
                <section id="proteccion-datos" className={styles.section}>
                ...
                <section id="propiedad-intelectual" className={styles.section}>
                ...
                <section id="resolucion-litigios" className={styles.section}>
                    <h2 className={styles.sectionTitle}>Resolución de Litigios</h2>
                    <p className={styles.text}>
                        En caso de conflicto, se intentará resolver de manera amistosa. Para usuarios consumidores, la Comisión Europea facilita una plataforma de resolución de litigios en línea: <a href="https://consumer-redress.ec.europa.eu/dispute-resolution-bodies" target="_blank" rel="noopener noreferrer" className={styles.link}>https://consumer-redress.ec.europa.eu/dispute-resolution-bodies</a>
                    </p>
                </section>

                <section id="aceptacion-condiciones" className={styles.section}>
                    <h2 className={styles.sectionTitle}>Aceptación de Condiciones</h2>
                    <p className={styles.text}>
                ...
                <section id="cuenta-usuario" className={styles.section}>
                    <h2 className={styles.sectionTitle}>Cuenta de Usuario y Corrección de Errores</h2>
                    <p className={styles.text}>
                ...
                <section id="formas-pago" className={styles.section}>
                ...
                <section id="precios" className={styles.section}>
                    <h2 className={styles.sectionTitle}>Precios, impuestos, tasas y aranceles</h2>
                    <p className={styles.text}>
